...
const Carousel : React.FC = () => {
  ...
  return (
    <div className="h-24 md:h-64 lg:h-64 w-full px-6 md:px-12">
      ...
      <ImageLinkComponent path = "/japandihouse" src= "./images/CoverImage/Japandi-5.jpeg" name = "JAPANDI HOUSEE"/>
      <ImageLinkComponent path = "/minjihouse" src= "./images/CoverImage/Minji-3.jpeg" name = "MIN-JI HOUSE"/>
      <ImageLinkComponent path = "/japandihouse" src= "./images/CoverImage/Japandi-2.jpeg" name = "JAPANDI HOUSEE"/>
      </Slider>
    </div>
  );
};
